...
async function handlePostClicked() {
  ...
  let text = `Thanks for your sharing! <br> <br>Your word count exceeds <b style="font-size: xx-large; color: red">${exceedPercentage}%</b> of the existing posts. I feel like you take a <b style="font-size: xx-large; color: red">${sentiment}</b> stance on this topic. Considering the ${sentiment} stance, Your claims contribute to a new claim center, resulting in a <b style="font-size: xx-large; color: red">${claimIncrease}%</b> increase in the proportion of this ${sentiment} stance group<br> <br>I'm pretty sure more and more people will learn a lot from your novel and fascinating answer!`;
